"""
Django settings for rifafacil project.
"""
...
env = environ.Env(
    DEBUG=(bool, True),
    SECRET_KEY=(str, 'django-insecure-local-dev-rifafacil'),
)
...
WSGI_APPLICATION = 'rifafacil.wsgi.application'
